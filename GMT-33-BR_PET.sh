...
gmt grdcut TerraClimate_pet_2020.nc -R285/328/-35/6 -Gbr_pet.nc
gdalinfo -stats br_pet.nc
# Minimum=0.000, Maximum=268.700, Mean=125.582, StdDev=32.983

# Make color palette
#gmt makecpt -Cprecip3_16lev -V -T0/268 > pauline.cpt
#gmt makecpt -Camwg_blueyellowred -V -T0/268 > pauline.cpt
#gmt makecpt -Cqual-mixed-12 -V -T0/268 > pauline.cpt
#gmt makecpt -CStepSeq25 -V -T0/268 > pauline.cpt
gmt makecpt -CBlAqGrYeOrRe -V -T0/268 > pauline.cpt

ps=BR_pet.ps
# Make background transparent image
gmt grdimage br_pet.nc -Cpauline.cpt -R285/328/-35/6 -JM6i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour br_pet.nc -R -J -C20 -A40 -Wthinner,brown -O -K >> $ps
...
gmt psscale -Dg285/-37.5+w15.2c/0.4c+h+o0.0/0i+ml -R -J -Cpauline.cpt \
    ...
    -Bg20f1a10+l"Colormap: 'StepSeq25' by NCAR Command Language [discrete, RGB, 25 segments]" \
...
gmt psbasemap -R -J \
    ...
    -B+t"PET (Potential Evapotranspiration) in Brazil (2020)" -O -K >> $ps
...
gmt psconvert BR_pet.ps -A0.5c -E720 -Tj -Z
