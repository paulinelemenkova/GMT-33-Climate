...
gmt grdcut TerraClimate_swe_2018.nc -R33/48/3/15 -Get_swe.nc
gdalinfo -stats et_swe.nc
...
gmt grdimage et_swe.nc -Cmyocean.cpt -R33/48/3/15 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour et_swe.nc -R -J -C5 -A10 -Wthin,white -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"SWE (Snow water equivalent at end of month) in Ethiopia (2018)" -O -K >> $ps
...
gmt psconvert ET_swe.ps -A0.5c -E720 -Tj -Z
