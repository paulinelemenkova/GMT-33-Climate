...
gmt grdcut TerraClimate_srad_2018.nc -R33/48/3/15 -Get_srad.nc
gdalinfo -stats et_srad.nc
# Minimum=195.000, Maximum=276.000

# Make color palette
gmt makecpt -Cpanoply.cpt -V -T195/276/1 > myocean.cpt
# gmt makecpt --help
# elevation etopo1 world elevation dem1 dem2 dem3

ps=ET_srad.ps
# Make background transparent image
gmt grdimage et_srad.nc -Cmyocean.cpt -R33/48/3/15 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour et_srad.nc -R -J -C5 -A10 -Wthin,white -O -K >> $ps

# Add coastlines, borders, rivers
gmt pscoast -R -J -P \
    -Ia/thinner,blue -Na -N1/thickest,green -W0.1p -Df -O -K >> $ps
...
gmt psscale -Dg31.7/3+w13.3c/0.15i+v+o0.0/0i+ml -R -J -Cmyocean.cpt \
    ...
    -Bg5f1a10+l"Colormap: 'panoply' default colormap of Panoply [T195/276/5, C=RGB]" \
...
gmt psbasemap -R -J \
    ...
    -B+t"srad (Downward surface shortwave radiation) in Ethiopia (2018)" -O -K >> $ps
...
gmt psconvert ET_srad.ps -A0.5c -E720 -Tj -Z
