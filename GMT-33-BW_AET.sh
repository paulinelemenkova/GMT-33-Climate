...
gmt grdcut TerraClimate_aet_2018.nc -R19.5/29.5/-27/-17.5 -Gbw_aet.nc
gdalinfo -stats bw_aet.nc
...
gmt grdimage bw_aet.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour bw_aet.nc -R -J -C10 -A10 -Wthin,blue -O -K >> $ps
...
gmt psscale -Dg19.3/-27.7+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg10f1a10+l"Colormap: 'bhw2 34' art gradients by Blackheartedwolf, Set 2 [-T13/148/1, 0-100, continuous, RGB, 4 segments]" \
    -I0.2 -By+lm -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"AET (Actual Evapotranspiration) in Botswana (2018)" -O -K >> $ps
...
gmt psconvert BW_AET.ps -A0.5c -E720 -Tj -Z
