...
gmt grdcut TerraClimate_PDSI_2020.nc -R285/328/-35/6 -Gbr_pdsi.nc
gdalinfo -stats br_pdsi.nc
# Minimum=-25.000, Maximum=20.470, Mean=-1.487, StdDev=3.513

# Make color palette
#gmt makecpt -Camwg_blueyellowred -V -T0/268 > pauline.cpt
#gmt makecpt -Chg -V -T-10/10 > pauline.cpt
#gmt makecpt -Ceawc_sub -V -T-10/10 > pauline.cpt
gmt makecpt -Cmin_top -V -T-10/10 > pauline.cpt

ps=BR_pdsi.ps
# Make background transparent image
gmt grdimage br_pdsi.nc -Cpauline.cpt -R285/328/-35/6 -JM6i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
# gmt grdcontour br_pdsi.nc -R -J -C1.0 -A4.0 -Wthinner,white -O -K >> $ps
...
gmt psscale -Dg285/-37.5+w15.2c/0.4c+h+o0.0/0i+ml -R -J -Cpauline.cpt \
    ...
    -Bg2f0.1a1+l"Colormap: 'min top' by ESDB [discrete, RGB, 8 segments]" \
...
gmt psbasemap -R -J \
    ...
    -B+t"PDSI (Palmer Drought Severity Index) in Brazil (2020)" -O -K >> $ps
...
gmt psconvert BR_pdsi.ps -A0.5c -E720 -Tj -Z
