...
# http://soliton.vm.bytemark.co.uk/pub/cpt-city/ncl/tn/precip3_16lev.png.index.html
...
gmt grdcut TerraClimate_aet_2020.nc -R285/328/-35/6 -Gbr_aet.nc
gdalinfo -stats br_aet.nc
# Minimum=0.000, Maximum=191.200, Mean=95.055, StdDev=29.451

# Make color palette
gmt makecpt -Cprecip3_16lev -V -T0/192 > pauline.cpt

ps=BR_aet.ps
# Make background transparent image
gmt grdimage br_aet.nc -Cpauline.cpt -R285/328/-35/6 -JM6i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour br_aet.nc -R -J -C20 -A40 -Wthinner,brown -O -K >> $ps
...
gmt psconvert BR_aet.ps -A0.5c -E720 -Tj -Z
