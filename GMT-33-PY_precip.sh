...
gmt grdcut TerraClimate_ppt_2020.nc -R297/306/-28/-19 -Gpy_ppt.nc
...
gmt grdimage py_ppt.nc -Cpauline.cpt -R297/306/-28/-19 -JM6.0i -I+a15+ne0.75 -t70 -Xc -P -K > $ps
...
# Add raster image
gmt grdimage py_ppt.nc -Cpauline.cpt -R297/306/-28/-19 -JM6.0i -I+a15+ne0.75 -Xc -P -O -K >> $ps
# Add isolines
gmt grdcontour py_ppt.nc -R -J -C20 -A40 -Wthin,white -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Precipitation in Paraguay (2020)" -O -K >> $ps
...
gmt psconvert PY_ppt.ps -A0.5c -E720 -Tj -Z
