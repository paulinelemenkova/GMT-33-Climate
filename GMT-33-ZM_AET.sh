...
gmt grdcut TerraClimate_aet_2018.nc -R21/34/-19/-8 -Gzm_aet.nc
gdalinfo -stats zm_aet.nc
# Minimum=13.000, Maximum=148.000, Mean=73.225, StdDev=28.295

# Make color palette
#gmt makecpt -Cbhw2_34.cpt -V -T13/148/1 -Ic > pauline.cpt
gmt makecpt -Cbcyr -V -T13/148/1 > pauline.cpt
...
gmt grdimage zm_aet.nc -Cpauline.cpt -R21/34/-19/-8 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour zm_aet.nc -R -J -C10 -A10 -Wthin,blue -O -K >> $ps
...
gmt psscale -Dg21.0/-20.0+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg10f1a10+l"Colormap: 'bcyr' colour ramp distributed with the GRASS GIS [-T13/148/1, 0-100, continuous, RGB, 3 segments]" \
    -I0.2 -By+lm -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"AET (Actual Evapotranspiration) in Zambia (2018)" -O -K >> $ps
...
gmt psconvert ZM_AET.ps -A0.5c -E720 -Tj -Z
