...
gmt grdcut TerraClimate_tmin_2013.nc -R-6/3/9/15.5 -Gbf_tim2013.nc
gdalinfo -stats bf_tim2013.nc
...
#gmt makecpt -Ccool.cpt -V -T10/22 > pauline.cpt

ps=BF_Tmin_2013.ps
# Make background transparent image
gmt grdimage bf_tim2013.nc -Cpauline.cpt -R-6/3/9/15.5 -JM6.5i -I+a15+ne0.75 -Xc -t20 -P -K > $ps
    
# Add isolines
gmt grdcontour bf_tim2013.nc -R -J -C0.5 -A1 -Wthick,blue -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Tmin (minimum temperature) in Burkina Faso (2013)" -O -K >> $ps
...
gmt psconvert BF_Tmin_2013.ps -A0.5c -E720 -Tj -Z
