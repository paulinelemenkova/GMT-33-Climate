...
gmt grdcut TerraClimate_ppt_2020.nc -R285/328/-35/6 -Gbr_precip.nc
gdalinfo -stats br_precip.nc
# Minimum=0.000, Maximum=691.100, Mean=169.669, StdDev=104.699

# Make color palette
#gmt makecpt -Cjet -V -T0/691 > pauline.cpt
#gmt makecpt -Chumidity -V -T0/691 -Ic > pauline.cpt
gmt makecpt -Chumidity -V -T0/691 > pauline.cpt

ps=BR_precip.ps
# Make background transparent image
gmt grdimage br_precip.nc -Cpauline.cpt -R285/328/-35/6 -JM6i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour br_precip.nc -R -J -C40 -A80 -Wthinner,brown -O -K >> $ps
...
gmt psscale -Dg285/-37.5+w15.2c/0.4c+h+o0.0/0i+ml -R -J -Cpauline.cpt \
    ...
    -Bg40f4a40+l"Colormap: 'humidity' by the Schemes for meteorological maps from the UK Met Office [-T0/366, 0 to 100, discrete, RGB, 25 segments]" \
    -I0.2 -By+l"mm" -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Precipitation in Brazil" -O -K >> $ps
...
gmt psconvert BR_precip.ps -A0.5c -E720 -Tj -Z
