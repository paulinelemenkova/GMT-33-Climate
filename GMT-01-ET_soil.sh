...
gmt grdcut TerraClimate_soil_2018.nc -R33/48/3/15 -Get_soil.nc
#gmt grdcut TerraClimate_soil_2008.nc -R33/48/3/15 -Get_soil.nc
#gmt grdcut GEBCO_2019.nc -R33/48/3/15 -Get_relief.nc
gdalinfo -stats et_soil.nc
...
gmt grdimage et_soil.nc -Cmyocean.cpt -R33/48/3/15 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour et_soil.nc -R -J -C20 -A20 -Wthinner,white -O -K >> $ps
...
gmt psconvert ET_Soil.ps -A0.5c -E720 -Tj -Z
