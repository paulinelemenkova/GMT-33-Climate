...
gmt grdimage bw_pet.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour bw_pet.nc -R -J -C10 -A10 -Wthin,blue -O -K >> $ps
...
gmt psscale -Dg19.3/-27.7+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg10f1a10+l"Colormap: 'bhw2 grrrrr' art gradients by Blackheartedwolf, Set 2 [-T133/250, 0-100, continuous, RGB, 7 segments]" \
    -I0.2 -By+lm -O -K >> $ps
