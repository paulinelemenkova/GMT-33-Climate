...
gmt grdcut TerraClimate_pet_2018.nc -R33/48/3/15 -Get_pet.nc
gdalinfo -stats et_pet.nc
# Minimum=80.000, Maximum=233.000

# Make color palette
gmt makecpt -Cturbo.cpt -V -T80/233/5 > myocean.cpt
# gmt makecpt --help
# elevation etopo1 world elevation dem1 dem2 dem3

ps=et_pet.ps
# Make background transparent image
gmt grdimage et_pet.nc -Cmyocean.cpt -R33/48/3/15 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour et_pet.nc -R -J -C20 -A20 -Wthinner,white -O -K >> $ps
...
gmt psscale -Dg31.5/3+w13.3c/0.15i+v+o0.0/0i+ml -R -J -Cmyocean.cpt \
    ...
    -Bg10f5a10+l"Colormap: 'turbo' [T80/233/5, C=RGB]" \
    -I0.2 -By+lmm -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"PET (Potential Evapotranspiration) in Ethiopia (2018)" -O -K >> $ps
...
gmt psconvert et_pet.ps -A0.5c -E720 -Tj -Z
