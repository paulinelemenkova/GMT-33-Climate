...
gmt grdcut TerraClimate_ppt_2018.nc -R33/48/3/15 -Get_precipitation.nc
gdalinfo -stats et_precipitation.nc
# Minimum=0.000, Maximum=211.000
...
gmt psscale -Dg31.5/3+w13.3c/0.15i+v+o0.0/0i+ml -R -J -Cmyocean.cpt \
    ...
    -Bg10f5a10+l"Color scale: 'sealand' [R=0/211, H=0, C=HSV]" \
    -I0.2 -By+lmm -O -K >> $ps
...
gmt psconvert ET_Precip.ps -A0.5c -E720 -Tj -Z
