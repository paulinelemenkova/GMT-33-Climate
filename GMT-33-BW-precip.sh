...
# http://soliton.vm.bytemark.co.uk/pub/cpt-city/heine/index.html
...
gmt grdcut TerraClimate_ppt_2018.nc -R19.5/29.5/-27/-17.5 -Gbw_precip.nc
gdalinfo -stats bw_precip.nc
# Minimum=14.000, Maximum=190.000, Mean=76.682, StdDev=29.548

# Make color palette
#gmt makecpt -Csunshine_diff_12lev.cpt -V -T14/190 > pauline.cpt
gmt makecpt -CGTS2012_epochs -V -T14/190 > pauline.cpt
# gmt makecpt --help
#-Ic
# elevation etopo1 world elevation dem1 dem2 dem3

ps=BW_precip.ps
gmt grdimage bw_precip.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour bw_precip.nc -R -J -C20 -A20 -Wthin,white -O -K >> $ps
...
gmt psscale -Dg19.3/-27.7+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg10f1a10+l"Colormap: 'GTS2012_epochs' gradient from C. Heine of the University of Sydney's EarthByte group [-T14/190, discrete, RGB, 26 segments]" \
    -I0.2 -By+l"mm" -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Precipitation in Botswana (2018)" -O -K >> $ps
...
# countries
gmt pstext -R -J -N -O -K \
-F+jTL+f9p,25,midnightblue+jLB >> $ps << EOF
...
gmt pstext -R -J -N -O -K \
-F+jTL+f9p,25,midnightblue+jLB >> $ps << EOF
23.3 -26.6 S O U T H   A F R I C A
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f9p,25,midnightblue+jLB >> $ps << EOF
...
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f15p,19,midnightblue+jLB >> $ps << EOF
23.1 -22.5 B  O  T  S  W  A  N  A
EOF
#
gmt pstext -R -J -N -O -K \
-F+f15p,20,midnightblue+jLB >> $ps << EOF
21.15 -24.10 K A L A H A R I
21.15 -24.55 D E S E R T
EOF
gmt pstext -R -J -N -O -K \
...
gmt psconvert BW_precip.ps -A0.5c -E720 -Tj -Z
