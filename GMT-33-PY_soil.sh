...
gmt grdcut TerraClimate_soil_2020.nc -R297/306/-28/-19 -Gpy_soil.nc
gdalinfo -stats py_soil.nc
# Minimum=0.100, Maximum=90.600, Mean=18.505, StdDev=19.523
gmt makecpt -Crainbow -T0/80 > pauline.cpt
...
gmt grdimage py_soil.nc -Cpauline.cpt -R297/306/-28/-19 -JM6.0i -I+a15+ne0.75 -t70 -Xc -P -K > $ps
...
# Add raster image
gmt grdimage py_soil.nc -Cpauline.cpt -R297/306/-28/-19 -JM6.0i -I+a15+ne0.75 -Xc -P -O -K >> $ps
# Add isolines
gmt grdcontour py_soil.nc -R -J -C10 -A20 -Wthinner,bisque3 -O -K >> $ps
...
gmt psscale -Dg297/-28.6+w15.2c/0.4c+h+o0.0/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg20f2a20+l"Colormap 'rainbow' Rainbow: magenta-blue-cyan-green-yellow-red [C=HSV] (-T0/80)" \
...
gmt psbasemap -R -J \
    ...
    -B+t"Soil moisture map of Paraguay (2020)" -O -K >> $ps
...
gmt psconvert PY_soil.ps -A0.5c -E720 -Tj -Z
