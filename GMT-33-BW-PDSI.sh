...
gmt grdcut TerraClimate_PDSI_2018.nc -R19.5/29.5/-27/-17.5 -Gbw_pdsi.nc
gdalinfo -stats bw_pdsi.nc
# Minimum=-5.100, Maximum=12.100, Mean=2.383, StdDev=3.854

# Make color palette
gmt makecpt -Cqual-mixed-12.cpt -V -T-5.1/12.1 > pauline.cpt
# gmt makecpt --help
#-Ic
...
gmt grdimage bw_pdsi.nc -Cpauline.cpt -R19.5/29.5/-27/-17.5 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour bw_pdsi.nc -R -J -C0.25 -A1.0 -Wthin,white -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"PDSI (Palmer Drought Severity Index) in Botswana (2018)" -O -K >> $ps
...
gmt psconvert BW_PDSI.ps -A0.5c -E720 -Tj -Z
