...
gmt grdcut TerraClimate_vap_2018.nc -R21/34/-19/-8 -Gzm_vap.nc
gdalinfo -stats zm_vap.nc
#  Minimum=1.280, Maximum=2.820, Mean=2.171, StdDev=0.181

# Make color palette
gmt makecpt -C16_colors -V -T1.28/2.82 > pauline.cpt

ps=ZM_VAP.ps
# Make background transparent image
gmt grdimage zm_vap.nc -Cpauline.cpt -R21/34/-19/-8 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour zm_vap.nc -R -J -C0.1 -A0.2 -Wthin,brown -O -K >> $ps
...
gmt psscale -Dg21.0/-20.0+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg0.2f0.02a0.2+l"Colormap: '16 colors' by ImageJ Java image processing program [1.28/2.82, discrete, RGB, 256 segments]" \
...
gmt psbasemap -R -J \
    ...
    -B+t"VaP (Vapor Pressure) anomaly in Zambia (2018)" -O -K >> $ps
...
gmt psconvert ZM_VAP.ps -A0.5c -E720 -Tj -Z
