...
# http://soliton.vm.bytemark.co.uk/pub/cpt-city/jjg/serrate/div/tn/srtSpectral10.png.index.html
...
gmt grdcut TerraClimate_srad_2018.nc -R21/34/-19/-8 -Gzm_srad.nc
gdalinfo -stats zm_srad.nc
# Minimum=124.000, Maximum=281.000, Mean=195.476, StdDev=43.011

# Make color palette
#gmt makecpt -Cjet -V -T124/281 > pauline.cpt
gmt makecpt -CsrtSpectral10 -V -T124/281 -Ic > pauline.cpt

ps=ZM_SRAD.ps
# Make background transparent image
gmt grdimage zm_srad.nc -Cpauline.cpt -R21/34/-19/-8 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour zm_srad.nc -R -J -C10 -A20 -Wthinner,brown -O -K >> $ps
...
gmt psscale -Dg21.0/-20.0+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg10f1a10+l"Colormap: 'srtSpectral10' serrated version of C. Brewer's diverging schemes [-T124/281, -5 to 5, mixed, RGB, 10 segments]" \
    -I0.2 -By+lm -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Downward surface shortwave radiation (srad) in Zambia (2018)" -O -K >> $ps
...
gmt psconvert ZM_SRAD.ps -A0.5c -E720 -Tj -Z
