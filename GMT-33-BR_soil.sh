...
gmt grdcut TerraClimate_soil_2020.nc -R285/328/-35/6 -Gbr_soil.nc
gdalinfo -stats br_soil.nc
# Minimum=0.000, Maximum=577.800, Mean=125.840, StdDev=124.345

# Make color palette
#gmt makecpt -Cpm3d06 -V -T0/578 > pauline.cpt
gmt makecpt -Csaga-22 -V -T0/578 > pauline.cpt

ps=BR_soil.ps
# Make background transparent image
gmt grdimage br_soil.nc -Cpauline.cpt -R285/328/-35/6 -JM6i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour br_soil.nc -R -J -C40 -A80 -Wthinner,brown -O -K >> $ps
...
gmt psscale -Dg285/-37.5+w15.2c/0.4c+h+o0.0/0i+ml -R -J -Cpauline.cpt \
    ...
    -Bg40f4a40+l"Colormap: 'saga-22' SAGA GIS preset colour-tables [continuous, RGB, 19 segments]" \
...
gmt psbasemap -R -J \
    ...
    -B+t"Soil moisture map of Brazil (2020)" -O -K >> $ps
...
gmt psconvert BR_soil.ps -A0.5c -E720 -Tj -Z
