...
gmt grdcut TerraClimate_pet_2020.nc -R297/306/-28/-19 -Gpy_pet.nc
gdalinfo -stats py_pet.nc
# Minimum=124.400, Maximum=206.500, Mean=166.802, StdDev=17.146
gmt makecpt -Cbcyr -T124/207 > pauline.cpt
...
gmt grdimage py_pet.nc -Cpauline.cpt -R297/306/-28/-19 -JM6.0i -I+a15+ne0.75 -t70 -Xc -P -K > $ps
...
# Add raster image
gmt grdimage py_pet.nc -Cpauline.cpt -R297/306/-28/-19 -JM6.0i -I+a15+ne0.75 -Xc -P -O -K >> $ps
# Add isolines
gmt grdcontour py_pet.nc -R -J -C20 -A40 -Wthinner,brown -O -K >> $ps
...
gmt psscale -Dg297/-28.6+w15.2c/0.4c+h+o0.0/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg20f1a10+l"Colormap 'bcyr', colour ramp distributed with the GRASS GIS (-T124/207)" \
...
gmt psbasemap -R -J \
    ...
    -B+t"PET (Potential Evapotranspiration), Paraguay (2020)" -O -K >> $ps
...
gmt psconvert PY_pet.ps -A0.5c -E720 -Tj -Z
