...
gmt grdcut TerraClimate_ws_2013.nc -R-6/3/9/15.5 -Gbf_ws2013.nc
gdalinfo -stats bf_ws2013.nc
# Minimum=1.700, Maximum=3.380, Mean=2.308, StdDev=0.296
...
gmt grdimage bf_ws2013.nc -Cpauline.cpt -R-6/3/9/15.5 -JM6.5i -I+a15+ne0.75 -Xc -t10 -P -K > $ps
    
# Add isolines
gmt grdcontour bf_ws2013.nc -R -J -C0.4 -A0.4 -Wthin,white -t25 -O -K >> $ps
...
# Add raster image
gmt grdimage bf_ws2013.nc -Cpauline.cpt -R-6/3/9/15.5 -JM6.5i -I+a15+ne0.75 -Xc -P -O -K >> $ps
# Add isolines
gmt grdcontour bf_ws2013.nc -R -J -C0.4 -A0.4 -Wthin,white -O -K >> $ps
# Add coastlines, borders, rivers
gmt pscoast -R -J \
...
gmt psbasemap -R -J \
    ...
    -B+t"Wind speed in Burkina Faso (2013)" -O -K >> $ps
