...
gmt grdcut TerraClimate_ppt_2018.nc -R21/34/-19/-8 -Gzm_precip.nc
gdalinfo -stats zm_precip.nc
# Minimum=124.000, Maximum=281.000, Mean=195.476, StdDev=43.011

# Make color palette
#gmt makecpt -Cjet -V -T124/281 > pauline.cpt
gmt makecpt -Chumidity -V -T0/366 -Ic > pauline.cpt

ps=ZM_precip.ps
# Make background transparent image
gmt grdimage zm_precip.nc -Cpauline.cpt -R21/34/-19/-8 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour zm_precip.nc -R -J -C40 -A80 -Wthinner,brown -O -K >> $ps
...
gmt psscale -Dg21.0/-20.0+w16.5c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg20f2a20+l"Colormap: 'humidity' by the Schemes for meteorological maps from the UK Met Office [-T0/366, 0 to 100, discrete, RGB, 25 segments]" \
    -I0.2 -By+l"mm" -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Precipitation in Zambia (2018)" -O -K >> $ps
...
gmt psconvert ZM_precip.ps -A0.5c -E720 -Tj -Z
