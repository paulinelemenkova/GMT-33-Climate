...
gmt grdcut TerraClimate_def_2018.nc -R33/48/3/15 -Get_def.nc
gdalinfo -stats et_def.nc
#  Minimum=0.000, Maximum=232.000.000

# Make color palette
gmt makecpt -Cwysiwyg.cpt -V -T1/232.000 -N > myocean.cpt
# gmt makecpt --help
# elevation etopo1 world elevation dem1 dem2 dem3

ps=ET_DEF.ps
# Make background transparent image
gmt grdimage et_def.nc -Cmyocean.cpt -R33/48/3/15 -JM6.5i -I+a15+ne0.75 -Xc -P -K > $ps
    
# Add isolines
gmt grdcontour et_def.nc -R -J -C20 -A20 -Wthinner,white -O -K >> $ps
...
# Add color legend
gmt psscale -Dg31.5/3+w13.3c/0.15i+v+o0.0/0i+ml+e -R -J -Cmyocean.cpt \
...
gmt psbasemap -R -J \
    ...
    -B+t"DEF (Climate Water Deficit) in Ethiopia (2018)" -O -K >> $ps
...
gmt psconvert ET_DEF.ps -A0.5c -E720 -Tj -Z
