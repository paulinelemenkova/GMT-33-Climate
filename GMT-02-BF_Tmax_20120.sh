...
gmt grdcut TerraClimate_tmax_2020.nc -R-6/3/9/15.5 -Gbf_tmax2020.nc
gdalinfo -stats bf_tmax2020.nc
# actual_range={28.19999885559082,37}
...
gmt grdimage bf_tmax2020.nc -Cpauline.cpt -R-6/3/9/15.5 -JM6.5i -I+a15+ne0.75 -Xc -t20 -P -K > $ps
    
# Add isolines
gmt grdcontour bf_tmax2020.nc -R -J -C0.5 -A1 -Wthick,blue -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Tmax (maximum temperature) in Burkina Faso (2020)" -O -K >> $ps
...
gmt psconvert BF_Tmax_2020.ps -A0.5c -E720 -Tj -Z
