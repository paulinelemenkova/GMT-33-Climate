...
gmt grdcut TerraClimate_tmax_2013.nc -R-6/3/9/15.5 -Gbf_tmax2013.nc
gdalinfo -stats bf_tmax2013.nc
# actual_range={27.77999877929688,37.14999771118164}

# Make color palette
gmt makecpt -Cwysiwyg.cpt -V -T27/38 > pauline.cpt
# gmt makecpt --help

ps=BF_Tmax_2013.ps
# Make background transparent image
gmt grdimage bf_tmax2013.nc -Cpauline.cpt -R-6/3/9/15.5 -JM6.5i -I+a15+ne0.75 -Xc -t20 -P -K > $ps
    
# Add isolines
gmt grdcontour bf_tmax2013.nc -R -J -C0.5 -A1 -Wthick,blue -O -K >> $ps
...
gmt psscale -Dg-6.0/8.4+w16.0c/0.15i+h+o0.3/0i+ml+e -R -J -Cpauline.cpt \
    ...
    -Bg1f0.1a1+l"Colormap wysiwyg: 20 well-separated RGB colors [C=RGB]" \
...
gmt psbasemap -R -J \
    ...
    -B+t"Tmax (maximum temperature) in Burkina Faso (2013)" -O -K >> $ps
...
gmt psconvert BF_Tmax_2013.ps -A0.5c -E720 -Tj -Z
