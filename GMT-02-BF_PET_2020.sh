...
gmt grdcut TerraClimate_pet_2020.nc -R-6/3/9/15.5 -Gbf_pet2020.nc
gdalinfo -stats bf_pet2020.nc
# actual_range={139,214.9000091552734}

# Make color palette
#gmt makecpt -Cturbo.cpt -V -T139/214 > pauline.cpt
gmt makecpt -Cturbo.cpt -V -T135/214 > pauline.cpt

ps=BF_pet_2020.ps
# Make background transparent image
gmt grdimage bf_pet2020.nc -Cpauline.cpt -R-6/3/9/15.5 -JM6.5i -I+a15+ne0.75 -Xc -t20 -P -K > $ps
    
# Add isolines
gmt grdcontour bf_pet2020.nc -R -J -C10 -A10 -Wthick,brown -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"PET (Potential Evapotranspiration) in Burkina Faso (2020)" -O -K >> $ps
...
gmt psconvert BF_pet_2020.ps -A0.5c -E720 -Tj -Z
